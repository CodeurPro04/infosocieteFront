const defaultContent = {
  ...
  home: {
    ...
    aboutBody:
      "Nous avions l'intention de moderniser et de simplifier l'accès à l'information juridique, légale et financière des entreprises, ainsi que d'accompagner les entrepreneurs au quotidien, grâce à INFO-DOCSFLOW. Vérifiez, examinez et téléchargez tous les documents et données relatifs à l'identité et aux procédures d'une entreprise en quelques clics seulement. INFO-DOCSFLOW a rassemblé pour vous les documents les plus importants, notamment les actes, les avis du BODACC, les extraits Kbis, les statuts, et bien plus encore...",
    serviceCards: [
      {
        title:
          "Accédez à toutes nos données et documents exclusifs sur les entreprises",
        body: "Chez INFO-DOCSFLOW, nous mettons à disposition tous les types de documents d'entreprises qu'ils soient juridiques, légaux ou financiers. N'attendez pas et demandez vos documents dès maintenant.",
      },
      {
        title:
          "Une équipe de services à la clientèle toujours prête à répondre à tous vos besoins",
  ...
  pages: {
    "a-propos": {
      ...
      sections: [
        {
          title: "Historique",
          body: "Depuis plus de 50 ans, INFO-DOCSFLOW fournit des services d'information sur les entreprises françaises. Nous proposons une gamme de produits adaptés afin d'obtenir des informations fiables sur les entreprises.",
        },
        {
          title: "Une experience de plus de 50 ans",
          body: "INFO-DOCSFLOW regroupe aujourd'hui un large éventail de données juridiques, légales et financières pour accompagner les professionnels et entrepreneurs.",
        },
      ],
    },
    offre: {
      ...
      advantages: [
        {
          ...
          body: "Profitez de notre service afin de trouver n'importe quel extrait de Kbis. Vous avez en plus la possibilité de demander 7 extraits de Kbis par mois.",
        },
        {
          title: "Actes, Brevets et Bilans",
          body: "Il peut être utile d'accéder aux informations contenues dans les documents des entreprises. INFO-DOCSFLOW vous permet d'accéder à ces informations.",
        },
        {
          title: "Diagnostics financier",
          body: "Le diagnostic financier NOTA-PME et/ou AFDCC est un des principaux documents qui permettent d'analyser la comptabilité d'une entreprise, avec INFO-DOCSFLOW bénéficiez de 30 diagnostics par mois.",
        },
        {
          title: "Recherche de TVA",
          body: "Besoin de savoir si votre numéro de TVA a été enregistré et validé  INFO-DOCSFLOW vous permet de retrouver si le numéro de TVA de n'importe quelle entreprise est valide.",
        },
        {
          title: "Service clientele personnalise",
          body: "Notre service vous permet aussi de contacter notre service clientèle en cas de problème ou de demande particulière. Notre équipe vous répondra aussi rapidement que possible.",
        },
        {
          title: "Formule",
    ...
    resiliation: {
      title: "Résiliation",
      body: "Vous voulez résilier votre formule INFO-DOCSFLOW  Vous pouvez le faire via ce formulaire en ligne en renseignant votre adresse e-mail. Votre demande sera prise en compte immédiatement.",
      field: "Email",
    },
    contact: {
      title: "Nous contacter",
      subtitle:
        "N'hésitez pas à nous contacter pour une question spécifique ou en cas de problème.",
      body: "Vous avez besoin de plus d'informations  Une question en particulière  Vous pouvez nous contacter via ce formulaire en ligne ou par téléphone. Un de nos agents se chargera de vous répondre le plus rapidement possible.",
    },
    reclamation: {
      title: "R\u00e9clamation",
      subtitle:
        "Envoyez nous toute vos r\u00e9clamation ici, notre \u00e9quipe se chargera de vous r\u00e9pondre le plus rapidement possible.",
      body: "Vous avez besoin de faire une r\u00e9clamation ? Une question en particuli\u00e8re ? Vous pouvez nous contacter via ce formulaire en ligne ou par t\u00e9l\u00e9phone. Un de nos agent se chargera de vous r\u00e9pondre le plus rapidement possible.",
    },
    connexion: {
      ...
      sections: [
        {
          ...
          body: "De plus, les entreprises peuvent utiliser les informations qu'il contient pour mener des enquêtes sur des sociétés concurrentes ou pour s'assurer de la stabilité financière d'un partenaire.",
        },
        {
          title: "Accés public",
          body: "Tout le monde a accès au Kbis car c'est un document public qui contient des informations publiques, que ce soit le Kbis de sa propre entreprise ou celui d'un tiers.",
        },
      ],
      meaningSection: {
        ...
        tail: "En outre, les chefs d'entreprise peuvent vérifier l'extrait Kbis d'un ?ventuel partenaire pour voir si son entreprise est en régle.",
      },
      extraSections: [
        {
          title:
            "Créer un compte bancaire professionnel et obtenir un financement",
          paragraphs: [
        ...
        },
        {
          ...
          tail: "Ces aides peuvent être demandées à des organismes privés chargés de les débourser ou à des organismes publics au sens strict du terme. Un Kbis récent doit être présent dans le dossier où cette derniére est fréquemment attribuée.",
        },
        {
        ...
        blocks: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "faire une demande auprès d'INFO-DOCSFLOW. La localisation du siège de l'entreprise doit être demandée au tribunal de commerce. Ensuite, l'intéress? peut s'envoyer par courrier une copie du Kbis de l'entreprise ;",
              "consulter les sites Internet consacrés aux données commerciales comme INFO-DOCSFLOW.pro. La partie intéressée peut obtenir directement le Kbis d'une entreprise tierce à partir de ces plateformes.",
            ],
          },
        ],
      },
      ...
      sections: [
        {
          ...
          body: "7 extraits de Kbis par mois, hotline service clientèle, derniers comptes annuels, derniers actes, derniers brevets, 30 diagnostics financiers NOTA-PME/AFDCC, fiche entreprise en PDF, recherche de numéro de TVA valide.",
        },
        {
          title: "Prix",
          body: "1,49 € pour 72 heures puis 49,99 € par mois si non résilié dans les 72h. Facturation à la date anniversaire, prélèvement bancaire. Libellé INFO-DOCSFLOW/INFO-DOCSFLOW.pro.",
        },
        {
          title: "Résiliation",
          body: "La formule est résilable à tout moment et gratuitement via la page Résiliation. Vous devez renseigner l'email utilisé lors de l'achat.",
        },
        {
          title: "Modalités",
        ...
        },
        {
          ...
          body: "L'extrait est disponible sous 48h en jour ouvré. En cas d'indisponibilité, INFO-DOCSFLOW peut décliner la demande et celle-ci ne sera pas comptée.",
        },
        {
          title: "Stockage et transfert",
          body: "Les informations sont stockées sur des serveurs sécurisés. Des transferts UE/tiers peuvent avoir lieu avec garanties adéquates. Des tiers peuvent traiter certaines données selon leurs politiques.",
        },
      ],
    },
    "votre-releve-bancaire": {
      title: "Service de HPY*INFOSCTE et Hp*INFO-DOCSFLOW",
      intro:
        "Si vous avez récemment consulté votre relevé bancaire et remarqué l'apparition de HPY*INFOSCTE ou Hp*INFO-DOCSFLOW parmi vos transactions, vous vous demandez probablement ce que cela représente. Ne vous inquiétez pas, nous sommes là pour clarifier cette énigme et vous aider à mieux comprendre vos finances.",
      questionTitle: "Qu'est-ce que HPY*INFOSCTE ou Hp*INFO-DOCSFLOW ?",
      questionBody:
        "HPY*INFOSCTE ou Hp*INFO-DOCSFLOW est une mention qui peut sembler obscure au premier abord. Cependant, derrière ces caractères se cache une signification spécifique liée à vos activités financières.",
      interpretationsTitle: "Interprétations",
      interpretations: [
        {
          title: "Transaction Commerciale",
          body: "HPY*INFOSCTE ou Hp*INFO-DOCSFLOW pourrait correspondre à un achat ou un paiement effectué avec votre carte bancaire. Il peut s'agir d'une transaction liée à notre service acheté en ligne.",
        },
        {
          title: "Abonnement",
          body: "La partie INFOSCTE suggère une transaction liée à des services. Cela peut inclure notre abonnement à notre service en ligne et des frais pour l'accès à nos données.",
        },
        {
          title: "Traitement en Cours",
          body: "Dans certains cas, HPY*INFOSCTE ou Hp*INFO-DOCSFLOW peut indiquer une transaction en cours de traitement ou d'autorisation. Les détails de la transaction peuvent ne pas encore être complets ou l'opération peut être en attente de confirmation.",
        },
      ],
      conclusionTitle: "Conclusion",
      conclusionBody:
        "En conclusion, HPY*INFOSCTE ou Hp*INFO-DOCSFLOW peut sembler énigmatique au premier abord, mais il est important de comprendre son contexte et sa signification sur votre relevé bancaire. En suivant les conseils ci-dessus, vous pouvez éviter toute confusion liée à cette inscription.",
      kbis: {
        label: "Extrait KBIS",
        title: "Recevez votre Kbis",
        highlights: [
    ...
    "hpy-infoscte": {
      title:
        "Annulez Facilement Votre Abonnement avec INFO-DOCSFLOW - HPY*INFO-DOCSFLOW à HPY*11 INFOSCTE",
      sections: [
        {
          title:
            'Résiliez Votre Abonnement en Quelques Clics avec INFO-DOCSFLOW pour "HPY*INFO-DOCSFLOW"',
          body: 'Vous souhaitez annuler votre abonnement marqué "HPY*INFO-DOCSFLOW" sur votre relevé bancaire en quelques clics seulement ? Avec INFO-DOCSFLOW, c’est désormais possible ! Utilisez notre formulaire en ligne convivial pour soumettre votre demande de résiliation facilement et rapidement. Simplifiez vos démarches dès aujourd’hui avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Comment Annuler Votre Abonnement en Ligne avec INFO-DOCSFLOW pour "HPY*1 INFOSCTE"',
          body: 'Besoin d’annuler votre abonnement marqué "HPY*1 INFOSCTE" sur votre relevé bancaire en toute simplicité ? Laissez INFO-DOCSFLOW vous guider ! Notre formulaire en ligne intuitif vous permet de résilier votre abonnement en quelques étapes simples. Mettez fin à votre abonnement sans tracas avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Annulez Rapidement Votre Abonnement en Ligne avec INFO-DOCSFLOW pour "HPY*2 INFOSCTE"',
          body: 'Avec INFO-DOCSFLOW, annuler votre abonnement marqué "HPY*2 INFOSCTE" sur votre relevé bancaire est un jeu d’enfant. Utilisez notre formulaire en ligne rapide et efficace pour soumettre votre demande de résiliation en quelques minutes seulement. Simplifiez vos démarches dès maintenant avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Résiliez Votre Abonnement Facilement avec INFO-DOCSFLOW pour "HPY*3 INFOSCTE"',
          body: 'Vous recherchez un moyen facile et rapide d’annuler votre abonnement marqué "HPY*3 INFOSCTE" sur votre relevé bancaire ? Ne cherchez plus ! Utilisez notre formulaire en ligne convivial pour mettre fin à votre abonnement en quelques clics seulement. Simplifiez vos résiliations dès aujourd’hui avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Mettez Fin à Votre Abonnement sans Stress avec INFO-DOCSFLOW pour "HPY*4 INFOSCTE"',
          body: 'Besoin de résilier votre abonnement marqué "HPY*4 INFOSCTE" sur votre relevé bancaire sans stress ni tracas ? Laissez INFO-DOCSFLOW vous accompagner ! Remplissez notre formulaire en ligne facile à utiliser pour annuler votre abonnement en toute simplicité. Simplifiez vos résiliations en ligne dès maintenant avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Annulation Simplifiée en Ligne avec INFO-DOCSFLOW pour "HPY*5 INFOSCTE"',
          body: 'Avec INFO-DOCSFLOW, annuler votre abonnement marqué "HPY*5 INFOSCTE" sur votre relevé bancaire n’a jamais été aussi simple. Utilisez notre formulaire en ligne intuitif pour soumettre votre demande de résiliation en quelques clics seulement. Simplifiez vos démarches dès aujourd’hui avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Découvrez Notre Formulaire de Résiliation en Ligne avec INFO-DOCSFLOW pour "HPY*6 INFOSCTE"',
          body: 'Envie d’annuler votre abonnement marqué "HPY*6 INFOSCTE" sur votre relevé bancaire en quelques clics seulement ? Laissez INFO-DOCSFLOW vous faciliter la tâche ! Notre formulaire en ligne rapide et efficace vous permet de résilier votre abonnement en toute simplicité. Simplifiez vos démarches dès maintenant avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Comment Résilier Facilement en Ligne avec INFO-DOCSFLOW pour "HPY*7 INFOSCTE"',
          body: 'Vous souhaitez résilier votre abonnement marqué "HPY*7 INFOSCTE" sur votre relevé bancaire sans souci ? Laissez INFO-DOCSFLOW vous aider ! Utilisez notre formulaire en ligne convivial pour mettre fin à votre abonnement en quelques étapes simples. Simplifiez vos résiliations dès aujourd’hui avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Annulez Votre Abonnement en Toute Tranquillité avec INFO-DOCSFLOW pour "HPY*8 INFOSCTE"',
          body: 'Mettez fin à votre abonnement marqué "HPY*8 INFOSCTE" sur votre relevé bancaire en toute tranquillité avec INFO-DOCSFLOW. Notre formulaire en ligne simplifié vous permet de résilier votre abonnement sans stress ni tracas. Simplifiez vos démarches dès maintenant avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Résiliez Votre Abonnement sans Tracas avec INFO-DOCSFLOW pour "HPY*9 INFOSCTE"',
        ...
        {
          title:
            'Comment Annuler Votre Abonnement en Ligne avec INFO-DOCSFLOW pour "HPY*10 INFOSCTE"',
          body: 'Vous recherchez un moyen facile et rapide d’annuler votre abonnement marqué "HPY*10 INFOSCTE" sur votre relevé bancaire ? Ne cherchez plus ! Utilisez notre formulaire en ligne intuitif pour mettre fin à votre abonnement en quelques clics seulement. Simplifiez vos résiliations dès aujourd’hui avec INFO-DOCSFLOW.',
        },
        {
          title:
            'Annulation Simplifiée en Ligne avec INFO-DOCSFLOW pour "HPY*11 INFOSCTE"',
          body: 'Avec INFO-DOCSFLOW, annuler votre abonnement marqué "HPY*11 INFOSCTE" sur votre relevé bancaire n’a jamais été aussi simple. Utilisez notre formulaire en ligne intuitif pour soumettre votre demande de résiliation en quelques clics seulement. Simplifiez vos démarches dès aujourd’hui avec INFO-DOCSFLOW.',
        },
      ],
  ...
  footer: {
    ...
    links: [
      ...
      {
        label: "Conditions formule premium",
        path: "/conditions-de-la-formule",
      },
      { label: "Contact", path: "/contact" },
